...
Last stable release 0.1.0: [Extractor](/releases/download/v0.1.0/z_moose_extractor.abap) and [Texts for extractor](/releases/download/v0.1.0/z_moose_extractor.abap.txt)
