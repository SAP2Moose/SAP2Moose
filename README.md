...
Last stable release v0.5.5: [Extractor](../../releases/download/v0.5.5/z_moose_extractor.abap) and [Texts for extractor](../../releases/download/v0.5.5/z_moose_extractor_texts.txt).. This is the first release where ADT links to ABAP classes and class components are extracted. Moose2Model v0.2.0 is required to use this links.
