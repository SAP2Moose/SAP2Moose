...
*    END-TEST-INJECTION.
    ...
    equalized_harmonized_mse_exp = VALUE #( ( |SOMIX.Data ABAPClassAttribute.sap.class_a.method_a name METHOD_A| )
                                            ( |SOMIX.Grouping ABAPGlobalClass.sap.class_a linkToEditor adt://SYS/sap/bc/adt/oo/classes/class_a/source/main| )
                                            ( |SOMIX.Grouping ABAPGlobalClass.sap.class_a name CLASS_A| )
...
CLASS ltcl_interface_SOMIX DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
...
CLASS ltcl_interface_SOMIX IMPLEMENTATION.
...
*                                            ( |FAMIX.FileAnchor INTERFACE_A fileName adt://SYS/sap/bc/adt/oo/interfaces/interface_a/source/main| )
*                                            ( |FAMIX.Package PACKAGE1| ) ).
    equalized_harmonized_mse_exp = VALUE #( ( |SOMIX.Grouping ABAPGlobalInterface.sap.interface_a linkToEditor adt://SYS/sap/bc/adt/oo/interfaces/interface_a/source/main| )
                                            ( |SOMIX.Grouping ABAPGlobalInterface.sap.interface_a name INTERFACE_A| )
                                            ( |SOMIX.Grouping ABAPPackage.sap.package1 name PACKAGE1| )
                                            ( |SOMIX.ParentChild parent ABAPPackage.sap.package1 child ABAPGlobalInterface.sap.interface_a| ) ).
