...
CLASS z2mse_extr_where_used_classes DEFINITION LOCAL FRIENDS ltcl_main.
CLASS ltcl_main DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.

  PRIVATE SECTION.
    DATA f_cut TYPE REF TO z2mse_extr_where_used_classes.
    METHODS:
...
CLASS ltcl_main IMPLEMENTATION.
  ...
  METHOD simple.
    ...
    DATA: wbcrossgt_test TYPE z2mse_extr_where_used_classes=>ty_t_wbcrossgt_test.
    ...
    DATA: includes_to_components TYPE z2mse_extr_where_used_classes=>ty_includes_to_components.
