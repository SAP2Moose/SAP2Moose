...
*      DATA class_components_builder TYPE REF TO z2mse_extr3_class_comps_build.
*
*      class_components_builder = z2mse_extr3_class_comps_build=>get_instance( i_element_manager = element_manager ).
*
*      class_components_builder->search_down( element_id = new_element_id ).
